...
ok symbol of true/O told that we must walk in balane coridor so use % and must be true, %/balance is for exampple on how much color black, and nonumbers O numbers is %, all need do like O
