...
there can be something like binary step of colors like black revert white then + = revert gray revert of gray shit color and this all colors have numbers in O, by colors maybe we can understood how numbers alg works..
