...
If investigate stick she by logic try to find balanced opposite for example 1 to 50, the same with triangel but to find balanced opposite triangel use self triangel style, the same pentagram, stick example bad|good, black|white.
