...
Also i can be mistaked and this draft so always need to look on O on balance, between one simple symbol and one large symbol maybe just text, and maybe all what we must to do record data in pentogram format and read data in this pentogram format.
