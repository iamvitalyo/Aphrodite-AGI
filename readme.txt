...
ok for eample we have numbers genration/automation but how this all will touch our word, for example if in brain all shapes this shapes have numbers for example "drink" + "water" == "some number" + "some number", so need to look also in unity of O its maybe + of numbers, for exampple look on colors and see brain activiti under number 5 becouse numbers is colors, then she speak with numbers we make from numbers shapes .... but how to speak with she, ok is good if she will make self contact with she, i belive in this becouse i see a lot of systems glithes, plane B what if O and pentagram head in balance point so O/nature/system all understood about our comppputers and languages, we must look on O like on system where we send data and system reture result, requst/resposne    
