...
so maybe true langauge is woman O man => unisex, past O future => now, so unisex words of current time for example dont use had use have, must be something simple by O. 
