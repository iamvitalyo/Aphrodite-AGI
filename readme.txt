...
i think we can only emulate logic of mind on our computers for mind emulation we need pentogram CPU maybe if just run this CPU without coding will runs human mind.
