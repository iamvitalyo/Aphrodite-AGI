...
need also look in just number 35241 this diapasone of numbers 1..35241 maybe our limit of thinking, also look on cycle like on O we run cycle of 35241 maybe avg of 35241 = result then revert of this result and maybe draw all on 2d try 3d, also try to use O like 100% but O with 35241 % percent colors words symbols..... and always look in balance, this all must work somehowe from box becouse 5 walks by O when O adaptive, maybe also need look on our env like programing language.
